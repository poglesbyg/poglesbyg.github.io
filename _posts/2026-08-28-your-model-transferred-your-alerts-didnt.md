---
layout: post
title: "Your model transferred. Your alerts didn't."
date: 2026-08-28
categories: [machine-learning, evaluation]
tags: [clinical-ml, sepsis, distribution-shift, calibration, physionet]
description: "A sepsis model crossed from medical ICU to surgical ICU with its AUROC almost intact and lost 91% of its clinical value. Discrimination and the operating point fail independently, and the one number everyone reports is insensitive to the failure that costs the most."
---
...
are on [GitHub](https://github.com/poglesbyg/sepsis-early-warning). The
[full report](https://poglesbyg.github.io/sepsis-early-warning/) includes an
interactive replay of individual admissions hour by hour.
